...
<div class="panel-heading"><span class="glyphicon glyphicon-plus-sign" ></span> Saisie d'un animal</div>
...
<input type="text" name="nombreenfant" class="form-control"   />
<span></span>
</div>
<div class="form-group">
...
<input type="text" name="nombrelactation" class="form-control"   />
<span></span>
</div>
<div class="form-group">
<label class="control-label">Nombre Velage</label>
<input type="text" name="nombrevelage" class="form-control"   />
<span></span>
</div>
<div>
